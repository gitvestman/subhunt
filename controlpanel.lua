function drawControlPanel()
    ...
    love.graphics.line(width/20 + 3.5*width/40 + screenx, height/6 + 1.5 * lineheight, width/20 + 3.5*width/40 + screenx, 4*height/6 + 4.5 * lineheight)
    love.graphics.setLineWidth(1)
    love.graphics.setColor(0.0, 1.0, 0.0) 
    ...
    love.graphics.setFont(smallFont)
    love.graphics.line((width - 9*width/40) + 7*width/40 + screenx, height/2, (width - 9*width/40) + screenx, height/2)
    love.graphics.line(width/20 + screenx, height/2, width/20+ 7*width/40 + screenx, height/2)
    love.graphics.setColor(0.05, 0.15, 0.05) 
...
function drawExplosions()
    for i=1, #explosions do
        ...
        if (time - explosions[i].time) < 2 then
            ...
            love.graphics.setLineWidth(2)
            love.graphics.circle("line", posx, posy, (time - explosions[i].time)*height/8)
            love.graphics.setLineWidth(1)
            love.graphics.setColor(0.1, 1.0, 0.1) 
        end
    end
