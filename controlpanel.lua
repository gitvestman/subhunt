function drawControlPanel()
    ...
    love.graphics.rectangle("line", 10*width/40, lineheight - 2, width/8, lineheight + 4)
    love.graphics.printf("Sonar", 10*width/40, lineheight, width/8, "center")
    ...
    love.graphics.rectangle("line", 25*width/40, lineheight - 2, width/8, lineheight + 4)
    love.graphics.printf("Torpedo", 25*width/40, lineheight, width/8, "center")
