function drawControlPanel()
    ...
    love.graphics.rectangle("fill", width/20, height/6, 7*width/40, 4*height/6)
    ...
    love.graphics.setColor(0.05, 0.15, 0.05) 
    love.graphics.rectangle("fill", width - 9*width/40, height/6, 7*width/40, 4*height/6)
    love.graphics.setColor(0.0, 1.0, 0.0) 
    ...
    love.graphics.setColor(0.1, 0.2, 0.1) 
    love.graphics.line(34.5*width/40, height/6 + 1.5 * lineheight, 34.5*width/40, 4*height/6 + 4.5 * lineheight)
    love.graphics.setColor(0.0, 1.0, 0.0) 
    ...
    love.graphics.print("[F]", 38*width/40+4, height/6 + 0.5*lineheight, 0, 1)
    love.graphics.print("[R]", 38*width/40+4, 4*height/6 + 2*lineheight, 0, 1)
    love.graphics.setFont(smallFont)
    ...
    love.graphics.setColor(0.05, 0.15, 0.05) 
    love.graphics.rectangle("fill", 11*width/40, lineheight - 2, width/8, lineheight * 2)
    love.graphics.setColor(0.0, 1.0, 0.0) 
    love.graphics.rectangle("line", 11*width/40, lineheight - 2, width/8, lineheight * 2)
    love.graphics.printf("Sonar", 11*width/40, lineheight * 1.4, width/8, "center")
    --love.graphics.print("Sonar", 10*width/40, height/6, 0, 1)
    love.graphics.setColor(0.05, 0.15, 0.05) 
    love.graphics.rectangle("fill", 24*width/40, lineheight - 2, width/8, lineheight * 2)
    love.graphics.setColor(0.0, 1.0, 0.0) 
    if (player.torpedoloading > 0) then
        love.graphics.setColor(0.1, 1.0, 0.1, 0.4) 
        love.graphics.setLineWidth(lineheight*2)
        love.graphics.line(24*width/40 + width/48*(6 - player.torpedoloading), lineheight * 2 - 2, 24*width/40 + width/8, lineheight * 2 - 2)
        love.graphics.setLineWidth(1)
        love.graphics.setColor(0.1, 0.7, 0.1) 
    end
    love.graphics.rectangle("line", 24*width/40, lineheight - 2, width/8, lineheight * 2)
    love.graphics.printf("Torpedo", 24*width/40, lineheight * 1.4, width/8, "center")
    ...
    love.graphics.setColor(0.1, 1.0, 0.1) 
    love.graphics.line(width/2 - player.rudder*5.5*height/40, 5*height/6 + lineheight, width/2 - player.rudder*6*height/40, 5*height/6 + 70)
